...
Approximately **20 hours across multiple sessions**, including test design, implementation, debugging, CI setup, optional visual/performance work, and documentation.
